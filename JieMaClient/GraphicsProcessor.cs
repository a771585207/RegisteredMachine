...
namespace JieMaClient
{
    ...
    {
        private static readonly GraphicsProcessor instance = new GraphicsProcessor();

        // 显示的static 构造函数
        //没必要标记类型 - 在field初始化以前
        static GraphicsProcessor()
        {
        ...
        public static GraphicsProcessor Instance
        {
            get
            {
                return instance;
        ...
        public List<System.Drawing.Point> FindPicture(string subPic, string parPic, System.Drawing.Rectangle searchRect, byte errorRange, double matchRate = 0.9, bool isFindAll = false)
        {
            var subBitmap = new Bitmap(subPic);
            var parBitmap = new Bitmap(parPic);

            List < System.Drawing.Point > points = FindPicture(subBitmap, parBitmap, searchRect, errorRange, matchRate, isFindAll);
            subBitmap.Dispose();
            parBitmap.Dispose();

            return points;
        }
        public List<System.Drawing.Point> FindPicture(string subPic, Bitmap parBitmap, System.Drawing.Rectangle searchRect, byte errorRange, double matchRate = 0.9, bool isFindAll = false)
        {
            var subBitmap = new Bitmap(subPic);
        ...
        public List<System.Drawing.Point> FindPicture(Bitmap subBitmap, Bitmap parBitmap, System.Drawing.Rectangle searchRect, byte errorRange, double matchRate = 0.9, bool isFindAll = false)
        {
        ...
        /// <returns></returns>
        public List<NumBody> FindText(string subPic, string parPic, System.Drawing.Rectangle searchRect, byte errorRange, double matchRate = 0.9, bool isFindAll = false)
        {
        ...
        /// <param name="errorRange"></param>
        /// <returns></returns>
        public int FindNumbers(Dictionary<int, string> numDic, string parPic, System.Drawing.Rectangle searchRect, byte errorRange = 8, double matchRate = 0.9)
        {
            //同一个区域找到多个相同的图片
